...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($libelle)) {
        $stmt = $pdo->prepare("INSERT INTO niveau (libelle) VALUES (:libelle)");
        if ($stmt->execute(['libelle' => $libelle])) {
            $message = '<div class="alert alert-success">Niveau d habilitation ajouté avec succès !</div>';
        } else {
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Formulaire Niveau d'habilitation</h3>
                        </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="" action="" method="post" novalidate>
                                        <span class="section">Ajouter </span>
